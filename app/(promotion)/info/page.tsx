          ...
          {infoCards.map((card) => (
            ...
            >
              ...
              >
                ...
                <div
                  className={cn(
                    "absolute inset-0 bg-sage/90 p-4 sm:p-6 flex items-start justify-center text-forest transition-all duration-300 overflow-auto",
        ...
        >
          <div className="space-y-4 max-w-5xl mx-auto py-12">
            <div className="space-y-12">
              <h1 className="text-xl sm:text-3xl  xl font-semibold">Track and Analyze Your Carbon Footprint with Carbonbusters!</h1>
